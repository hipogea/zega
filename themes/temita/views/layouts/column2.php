...
<?php $this->beginContent('//layouts/main'); ?>
                ...
                <div>
                  ...
                  //  $model=Tipocambio::model()->find("codmon2='".$monedaalterna."'");
                    ...
                    <div  id="zonacompra"> <?php echo (!Yii::app()->user->isGuest)?CHtml::link(CHtml::image($rutabase.'/img/dinero.png',"hola",array('width'=>'20','height'=>'20')),'#',array('onclick'=>"$('#cru-framegeneral').attr('src','$createUrlx '); $('#cru-dialoggeneral').dialog('open');")):""; ?>
                        <span class="label badge-success" >Compra : <?php  echo ROUND(yii::app()->tipocambio->getcompra($monedaalterna),2)  ;  ?> </span>..<span class="label badge-warning " >  Venta  : <?php  echo round(1/yii::app()->tipocambio->getventa($monedaalterna),2)  ;  ?></span></div>
                ...
                <div> <!--INICIA DIV DE USUARIO -->
                   ...
                   <?php if(Noticias::isAdminTablon()) { ?>
                            <div>
                                ...
                                <?php echo CHtml::link(' Avisos porpabrobar ',Yii::app()->baseUrl.'/noticias/poraprobar',  ''); ?>
                                <span class="label badge-warning">
    ...
    <?php endif */?>
        ...
        {
            yii::app()->user->setFlash('error','Ha excedido el numero de documentos editados permitidos ('.$docbloqueados.'/'.yii::app()->settings->get('documentos','documentos_numeromaxbloqueos').') Si no los va a editar, por favor salga del modo edicion de estos documentos ');
