...
class ExportableGridBehavior extends CBehavior {
    ...
    public $filename = 'exportacion.csv';		//Filename suggested to user when downloading
    ...
    public function renderExportGridButton(CGridView $grid, $label = 'Exportar', $htmlOptions = array()) {
