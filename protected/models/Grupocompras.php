...
/**
 * This is the model class for table "{{grupocompras}}".
 *
 * The followings are the available columns in table '{{grupocompras}}':
 ...
 */
class Grupocompras extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Grupocompras the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('nomgru, creadoel, modificadoel', 'length', 'max'=>20),
