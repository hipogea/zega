	...
	public function eligeclase($codmov){
		switch($codmov) {
			...
			return 'VwAlmacendocs';
				break;
			case MOV_REINGRESO_MATERIAL: case MOV_INGRESO_COMPRA: case AN_MOV_INGRESO_CONSIGNACION: case MOV_DEVOLUCION_PROVEEDOR:
			return 'VwOcompra';
				break;
